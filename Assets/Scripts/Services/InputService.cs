...
namespace Services
{
    public class InputService
    {
        ...
        public bool MedicineChest => Input.GetKeyDown(KeyCode.Q);
        public bool ReloadBatarey => Input.GetKeyDown(KeyCode.R);

        public bool PickupPressed => Input.GetMouseButtonDown(0);
        public bool PickupReleased => Input.GetMouseButtonUp(0);
    }
}
